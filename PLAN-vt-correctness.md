...
**Step 8b (ARCHITECT-directed):** thorough jam_terminal audit for other static lookup-table patterns that should adopt the DecMode Bimap shape — deterministic + consistency. Inventory first, ARCHITECT disposes, refactors follow.
