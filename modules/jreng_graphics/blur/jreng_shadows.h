#pragma once
#include "internal/jreng_cached_shadows.h"
...
/*  A drop shadow is a path filled by a single color and then blurred.
    ...
    jreng::DropShadow shadow = {{ juce::Colours::black, 8, { -2, 0 }, 2 }};
...
public:
    ...
    // jreng::DropShadow ({Colour::fromRGBA (255, 183, 43, 111), pulse (6)}).render (g, button);
