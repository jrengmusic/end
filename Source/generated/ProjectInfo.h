 ...
 */
    ...
    static constexpr const char* const projectName      { "END"                                              };///< Product name.
    ...
    static constexpr const char* const versionString    { "0.0.1"                                            };///< Product version string.
    static constexpr int               versionNumber    { 0x1                                                };///< Product version, JUCE hex encoding.
    ...
    static constexpr const char* const presetExtension  { "end"                                              };///< Preset file extension, without the leading dot.
