...
/** @class Window
 *  @brief Listener-driven config-reactive window.
 *
 *  Inherits jam::Window for glassmorphism and adds juce::ValueTree::Listener
...
public:
     ...
     */
    Window (juce::Component* mainComponent, const juce::String& name, bool alwaysOnTop, bool showWindowButtons);
