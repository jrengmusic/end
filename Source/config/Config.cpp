...
void Config::initDefaults()
{
    ...
    values[Key::keysSplitHorizontal] = "\\";
...
void Config::writeDefaults (const juce::File& file) const
{
    ...
    content <<
        ...
        "END = {\n"
        "    font = {\n"
        "        -- Font family name for the terminal\n"
        "        family = \"Display Mono\",\n"
        "\n"
        ...
        "\n"
        "    cursor = {\n"
        "        -- Cursor character (Unicode block by default)\n"
        "        char = \"\\u{2588}\",\n"
        "\n"
        ...
        "        foreground = \"#FF4E8C93\",\n"
        "\n"
        "        -- Default background colour (alpha controls opacity)\n"
        "        background = \"#E0090D12\",\n"
        "\n"
        "        -- Cursor colour\n"
        "        cursor = \"#FF4E8C93\",\n"
        "\n"
        "        -- Selection highlight colour (semi-transparent)\n"
        "        selection = \"#8000C8D8\",\n"
        "\n"
        "        -- ANSI colour 0: black\n"
        "        black = \"#FF090D12\",\n"
        ...
        "\n"
        "    scrollback = {\n"
        "        -- Maximum scrollback lines (100 - 1000000)\n"
        "        num_lines = 10000,\n"
        "\n"
        ...
        "        prefix_timeout = 1000,\n"
        "\n"
        "        -- Focus pane to the left (after prefix)\n"
        "        pane_left = \"h\",\n"
        "\n"
        "        -- Focus pane below (after prefix)\n"
        "        pane_down = \"j\",\n"
        "\n"
        "        -- Focus pane above (after prefix)\n"
        "        pane_up = \"k\",\n"
        "\n"
        "        -- Focus pane to the right (after prefix)\n"
        "        pane_right = \"l\",\n"
        "    },\n"
        "}\n";
