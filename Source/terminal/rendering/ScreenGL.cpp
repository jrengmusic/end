...
void Screen<Context>::glContextCreated()
{
    textRenderer.createContext();
}

template <typename Context>
void Screen<Context>::renderOpenGL (int originX, int originY, int fullHeight)
{
...
template <typename Context>
void Screen<Context>::glContextClosing()
{
    textRenderer.closeContext();
}

template <typename Context>
bool Screen<Context>::isGLContextReady() const noexcept
{
 ...
 */
template <typename Context>
void Screen<Context>::drawCursor (const Render::Snapshot& snapshot)
{
...
template <typename Context>
void Screen<Context>::renderPaint (juce::Graphics& g, int originX, int originY, int fullHeight)
{
